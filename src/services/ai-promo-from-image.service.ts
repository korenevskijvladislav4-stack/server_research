...
- mechanics: кратко правила участия — ВСЕГДА на русском языке (переведи и сожми текст с баннера/письма на русский, без английских абзацев).
...
ВАЖНО: поле mechanics (если заполняешь) — только русский язык, даже если промо на баннере на английском.
