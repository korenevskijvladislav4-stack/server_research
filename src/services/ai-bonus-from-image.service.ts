...
- notes: внутренние заметки для CRM — ВСЕГДА на русском языке. Сожми сюда всё полезное с баннера/письма, что не вошло в остальные поля (ограничения по странам, ставкам, играм, срокам, исключения). Если исходник на английском или другом языке — перефразируй и переведи на русский. Не оставляй notes на английском; при отсутствии смысла можно null.
...
ВАЖНО:
- Поле notes: только русский текст (кириллица). Это обязательное правило для этого поля, даже если на баннере только латиница.
